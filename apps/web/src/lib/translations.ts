...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'tasks.allAssignees': 'All Staff',
    'tasks.dateAll': 'All',
    'tasks.dateToday': 'Today',
    'tasks.dateWeek': 'This Week',
    'tasks.dateMonth': 'This Month',
    'tasks.titleLabel': 'Title',
    'tasks.titlePlaceholder': 'Task title',
    'tasks.description': 'Description',
    'tasks.descriptionPlaceholder': 'Optional description',
    'tasks.assignTo': 'Assign To',
    'tasks.createTask': 'Create Task',
    'tasks.recurring': 'Repeat',
    'tasks.recurringNone': 'None',
    'tasks.recurringDaily': 'Daily',
    'tasks.recurringWeekly': 'Weekly',
    'tasks.recurringMonthly': 'Monthly',
    'tasks.recurringHint': 'Task will repeat automatically when completed',
    'tasks.categoryCleaning': 'Cleaning',
    'tasks.categoryCooking': 'Cooking',
    'tasks.categoryLaundry': 'Laundry',
    'tasks.categoryKids': 'Kids',
    'tasks.categoryShopping': 'Shopping',
  ...
  ur: {
    ...
    'tasks.allAssignees': 'تمام عملہ',
    'tasks.dateAll': 'سب',
    'tasks.dateToday': 'آج',
    'tasks.dateWeek': 'اس ہفتے',
    'tasks.dateMonth': 'اس مہینے',
    'tasks.titleLabel': 'عنوان',
    'tasks.titlePlaceholder': 'کام کا عنوان',
    'tasks.description': 'تفصیل',
    'tasks.descriptionPlaceholder': 'اختیاری تفصیل',
    'tasks.assignTo': 'تفویض کریں',
    'tasks.createTask': 'کام بنائیں',
    'tasks.recurring': 'دہرائیں',
    'tasks.recurringNone': 'کوئی نہیں',
    'tasks.recurringDaily': 'روزانہ',
    'tasks.recurringWeekly': 'ہفتہ وار',
    'tasks.recurringMonthly': 'ماہانہ',
    'tasks.recurringHint': 'کام مکمل ہونے پر خود بخود دہرایا جائے گا',
    'tasks.categoryCleaning': 'صفائی',
    'tasks.categoryCooking': 'کھانا پکانا',
    'tasks.categoryLaundry': 'کپڑے دھونا',
    'tasks.categoryKids': 'بچے',
    'tasks.categoryShopping': 'خریداری',
    'tasks.categoryOther': 'دوسرے',
  ...
  tl: {
    ...
    'tasks.allAssignees': 'Lahat ng Staff',
    'tasks.dateAll': 'Lahat',
    'tasks.dateToday': 'Ngayon',
    'tasks.dateWeek': 'Ngayong Linggo',
    'tasks.dateMonth': 'Ngayong Buwan',
    'tasks.titleLabel': 'Pamagat',
    'tasks.titlePlaceholder': 'Pamagat ng gawain',
    'tasks.description': 'Paglalarawan',
    'tasks.descriptionPlaceholder': 'Opsyonal na paglalarawan',
    'tasks.assignTo': 'Italaga sa',
    'tasks.createTask': 'Gumawa ng Gawain',
    'tasks.recurring': 'Ulitin',
    'tasks.recurringNone': 'Wala',
    'tasks.recurringDaily': 'Araw-araw',
    'tasks.recurringWeekly': 'Linguhan',
    'tasks.recurringMonthly': 'Buwan-buwan',
    'tasks.recurringHint': 'Ang gawain ay uulit kapag natapos',
    'tasks.categoryCleaning': 'Paglilinis',
    'tasks.categoryCooking': 'Pagluluto',
    'tasks.categoryLaundry': 'Labada',
    'tasks.categoryKids': 'Mga Bata',
    'tasks.categoryShopping': 'Pamimili',
    'tasks.categoryOther': 'Iba pa',
  ...
  sw: {
    ...
    'tasks.allAssignees': 'Wote',
    'tasks.dateAll': 'Zote',
    'tasks.dateToday': 'Leo',
    'tasks.dateWeek': 'Wiki Hii',
    'tasks.dateMonth': 'Mwezi Huu',
    'tasks.titleLabel': 'Jina',
    'tasks.titlePlaceholder': 'Jina la kazi',
    'tasks.description': 'Maelezo',
    'tasks.descriptionPlaceholder': 'Maelezo ya ziada',
    'tasks.assignTo': 'Peana kwa',
    'tasks.createTask': 'Unda Kazi',
    'tasks.recurring': 'Rudia',
    'tasks.recurringNone': 'Hakuna',
    'tasks.recurringDaily': 'Kila Siku',
    'tasks.recurringWeekly': 'Kila Wiki',
    'tasks.recurringMonthly': 'Kila Mwezi',
    'tasks.recurringHint': 'Kazi itarudia ikimaliza',
    'tasks.categoryCleaning': 'Usafi',
    'tasks.categoryCooking': 'Kupika',
    'tasks.categoryLaundry': 'Kufua',
    'tasks.categoryKids': 'Watoto',
    'tasks.categoryShopping': 'Ununuzi',
    'tasks.categoryOther': 'Nyingine',
  ...
  am: {
    ...
    'tasks.allAssignees': 'ሁሉም ሰራተኞች',
    'tasks.dateAll': 'ሁሉም',
    'tasks.dateToday': 'ዛሬ',
    'tasks.dateWeek': 'በዚህ ሳምንት',
    'tasks.dateMonth': 'በዚህ ወር',
    'tasks.titleLabel': 'ርዕስ',
    'tasks.titlePlaceholder': 'የተግባር ርዕስ',
    'tasks.description': 'መግለጫ',
    'tasks.descriptionPlaceholder': 'አማራጭ መግለጫ',
    'tasks.assignTo': 'መድብ ለ',
    'tasks.createTask': 'ተግባር ፍጠር',
    'tasks.recurring': 'ድገም',
    'tasks.recurringNone': 'የለም',
    'tasks.recurringDaily': 'በየቀኑ',
    'tasks.recurringWeekly': 'በየሳምንቱ',
    'tasks.recurringMonthly': 'በየወሩ',
    'tasks.recurringHint': 'ተግባሩ ሲጠናቀቅ በራስ ሰር ይደገማል',
    'tasks.categoryCleaning': 'ማጽዳት',
    'tasks.categoryCooking': 'ማብሰል',
    'tasks.categoryLaundry': 'ልብስ ማጠብ',
    'tasks.categoryKids': 'ልጆች',
    'tasks.categoryShopping': 'ግዢ',
    'tasks.categoryOther': 'ሌላ',
